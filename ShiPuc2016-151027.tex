...
\begin{figure}[t]
	...
	{\label{fig:example:e0}\includegraphics[width=0.5\textwidth]{Figure1.eps}}		
	%\begin{minipage}[t]{1\linewidth}
	\subfigure[The layers.]{\label{fig:example:e1}\includegraphics[width=0.24\textwidth,height=3cm ]{LayerGraph.eps}}
	\subfigure[ $t$-SPREAD graph.]{\label{fig:example:e2}\includegraphics[width=0.24\textwidth]{Figure2.eps}}
	%\end{minipage}
	\caption{Examples}
\end{figure}
\vspace{-0.5cm}
...
\begin{figure}[!htb]
	...
	{\label{fig:e1:b}\includegraphics[width=0.5\textwidth]{1000-1-4.eps}}
	\subfigure[Network with 5000 nodes ]
	{\label{fig:e1:c}\includegraphics[width=0.5\textwidth]{5000-d0.eps}}
	\caption{The impact of average degree}
\end{figure}

\begin{figure}[!htb]
	\subfigure[Average degree is 3]
	{\label{fig:e1:d}\includegraphics[width=0.5\textwidth]{200-500-3.eps}}
	\subfigure[Average degree is 4]
	{\label{fig:e1:e}\includegraphics[width=0.5\textwidth]{200-500-4.eps}}
	\caption{The impact of number of nodes}
\end{figure}

\begin{figure}[!htb]
	\subfigure[The impact of number of nodes]
	{\label{fig:e1:f}\includegraphics[width=0.5\textwidth]{2000-5000-10000.eps}}
	\subfigure[The impact of average degree]
	{\label{fig:e1:g}\includegraphics[width=0.5\textwidth]{5000-1-4.eps}}
	\caption{The impact of network size and average degree}
\end{figure}

\begin{figure}[!htb]
	\subfigure[Performance on real-world networks(The size of $D_0$)]
	{\label{fig:e2:a}\includegraphics[width=0.5\textwidth]{real-d0.eps}} \hfil
	\subfigure[Performance on real-world networks(The running time)]
	{\label{fig:e2:b}\includegraphics[width=0.5\textwidth]{real-time.eps}}
...
{\label{fig:e4:a}\includegraphics[width=0.5\textwidth]{our-wang.eps}} \hfil
\subfigure[Comparison about time ]
{\label{fig:e4:b}\includegraphics[width=0.5\textwidth]{our-wang-time.eps}}
