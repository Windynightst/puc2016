...
\begin{figure}[!htb]
	...
	\centering
	\subfigure[$j \neq 0$]
	{\label{fig:th1:a}\includegraphics[width=0.23\textwidth]{21.eps}}\hfil
	\subfigure[$j = 0$]
	{\label{fig:th1:b}\includegraphics[width=0.23\textwidth]{20.eps}}\hfil
...
\begin{figure}[!htb]
	...
	\centering
	\subfigure[$j \neq 0$]
	{\label{fig:th2:a}\includegraphics[width=0.23\textwidth]{16.eps}} \hfil
	\subfigure[$j = 0$]
	{\label{fig:th2:b}\includegraphics[width=0.23\textwidth]{18.eps}} \hfil
...
%	\label{fig:th3}
	\centering
	\subfigure[$j = k$]{\includegraphics[width=0.23\textwidth]{23.eps}}
...
\begin{figure}[!htb]
	\centering
	\subfigure[~]
	{\label{fig:th4:a}\includegraphics[width=0.23\textwidth]{24.eps}
		\label{fig:th4:b}\includegraphics[width=0.23\textwidth]{29.eps}}
...
\begin{figure}[!htb]
	\centering
	\subfigure[~]
	{\label{fig:th5:a}\includegraphics[width=0.23\textwidth]{31.eps}
		\label{fig:th5:b}\includegraphics[width=0.23\textwidth]{37.eps}}
...
\begin{figure}[!htb]
	...
	{\label{fig:e1:b}\includegraphics[width=0.23\textwidth, height=2cm ]{1000-1-4.eps}}
	\subfigure[Network with 5000 nodes ]
	{\label{fig:e1:c}\includegraphics[width=0.23\textwidth, height=2cm]{5000-d0.eps}}
	\caption{The impact of average degree}
\end{figure}

\begin{figure}[!htb]
	\subfigure[Average degree is 3]
	{\label{fig:e1:d}\includegraphics[width=0.23\textwidth, height=2cm]{200-500-3.eps}}
	\subfigure[Average degree is 4]
	{\label{fig:e1:e}\includegraphics[width=0.23\textwidth, height=2cm]{200-500-4.eps}}
	\caption{The impact of number of nodes}
\end{figure}

\begin{figure}[!htb]
	\subfigure[The impact of number of nodes]
	{\label{fig:e1:f}\includegraphics[width=0.23\textwidth, height=2cm]{2000-5000-10000.eps}}
	\subfigure[The impact of average degree]
	{\label{fig:e1:g}\includegraphics[width=0.23\textwidth, height=2cm]{5000-1-4.eps}}
	\caption{The impact of network size and average degree}
\end{figure}

\begin{figure}[!htb]
	\subfigure[Performance on real-world networks(The size of $D_0$)]
	{\label{fig:e2:a}\includegraphics[width=0.23\textwidth, height=2cm]{real-d0.eps}} \hfil
	\subfigure[Performance on real-world networks(The running time)]
	{\label{fig:e2:b}\includegraphics[width=0.23\textwidth, height=2cm]{real-time.eps}}
...
%	\centering
%	\subfigure[average degree is 3]
%	{\label{fig:e2:a}\includegraphics[width=0.23\textwidth]{200-500-3.eps}}
%	\hfil
%	\subfigure[average degree is 4]
%	{\label{fig:e2:b}\includegraphics[width=0.23\textwidth]{200-500-4.eps}}
...
%\centering
%\subfigure[a]
%{\label{fig:e3:a}\includegraphics[width=0.23\textwidth]{2000-5000-10000.eps}}
%\subfigure[b]
%{\label{fig:e3:b}\includegraphics[width=0.23\textwidth]{5000-4-time.eps}} \hfil
...
%{\label{fig:e4:a}\includegraphics[width=0.23\textwidth]{our-wang.eps}} \hfil
%\subfigure[Comparison about time ]
%{\label{fig:e4:b}\includegraphics[width=0.23\textwidth]{our-wang-time.eps}}
